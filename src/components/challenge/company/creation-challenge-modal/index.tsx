...
// Encapsula o motion.div com ref para ser usado no Dialog
...
export function CreationChallengeModal({ empresaId, open, onClose }: Props) {
    ...
    >
      ...
      <DialogContent dividers>
        <form onSubmit={handleSubmit}>
          <Stack spacing={3}>
            {isError && <Alert severity="error">Erro ao criar desafio.</Alert>}
            {isSuccess && <Alert severity="success">Desafio criado com sucesso!</Alert>}
                ...
                MenuProps: {
                  PaperProps: {
                    sx: {
                      ...
                      borderRadius: 'var(--radius)',
                      boxShadow: 'none', // <- remove sombra branca
                      padding: 0,        // <- remove padding branco
                    },
                  },
                },
              }}
